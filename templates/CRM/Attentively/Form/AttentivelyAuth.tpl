<div class="crm-section">
   ...
   <div>
     <ol>
        <li>You agree to share with JMA Consulting for the purposes of billing and support by JMA Consulting and Attentive.ly: 
           <ol>
               <li>The domain name and organization address and contact information of the organization using CiviCRM.</li>
